...
const Home = () => {
    ...
    const { data: blogs, isPending, error } = useFetch('http://localhost:8000/blogs'); //here the data: blogs means that grab the data and call it blogs in the current scope
